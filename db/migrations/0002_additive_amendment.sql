-- =====================================================================
-- MIGRATION 0002 — ADDITIVE AMENDMENT (approved v3.1.0 / DECISIONS.md)
-- =====================================================================
-- Copied verbatim from docs/amendments/DB_MIGRATION_0002_ADDITIVE.sql.
-- Do not edit here; edit the approved amendment (product owner) and re-copy.
-- CI verifies this file is byte-identical to the amendment below the header.
-- =====================================================================
