...
export const endpointStatus: EndpointStatusEntry[] = [
  ...
  { method: "POST", path: "/onboarding/register", phase: 2, status: "mock", notes: "v3.1.0" },
  { method: "GET", path: "/onboarding/applications-list", phase: 2, status: "mock", notes: "v3.1.0" },
  { method: "POST", path: "/onboarding/applications", phase: 2, status: "mock" },
  { method: "GET", path: "/onboarding/applications/{id}", phase: 2, status: "mock" },
  { method: "POST", path: "/onboarding/applications/{id}/submit", phase: 2, status: "mock" },
  { method: "POST", path: "/onboarding/applications/{id}/bank-account", phase: 2, status: "mock" },
  { method: "POST", path: "/onboarding/applications/{id}/consents", phase: 2, status: "mock" },
  { method: "GET", path: "/onboarding/applications/{id}/information-requests", phase: 2, status: "mock" },
  { method: "POST", path: "/onboarding/applications/{id}/respond", phase: 2, status: "mock" },
  { method: "POST", path: "/onboarding/applications/{id}/decide", phase: 2, status: "mock" },
  { method: "POST", path: "/government/lookup", phase: 2, status: "mock" },
  { method: "GET", path: "/government/requests/{id}", phase: 2, status: "mock" },
