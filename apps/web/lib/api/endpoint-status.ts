...
export const endpointStatus: EndpointStatusEntry[] = [
  ...
  { method: "GET", path: "/documents/{id}/download-url", phase: 3, status: "mock", notes: "no screen consumes it yet — needs Q-12's document list first" },
  ...
  { method: "POST", path: "/transactions/{id}/declarations", phase: 3, status: "mock", notes: "wizard step 5 · template version provisional (Q-13)" },
  { method: "POST", path: "/transactions/{id}/submit", phase: 3, status: "mock", notes: "wizard step 6 · 409 duplicate → blocked screen, reference shape provisional (Q-11)" },
